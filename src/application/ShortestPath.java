...
/**
 * 
 * It models Finding Shortest Path
 * 
 * @author Ismail AKBUDAK
 *
 */

public class ShortestPath extends Base {
	...
	public void model() {
		...
		// 1000 - large value to remove possibility of self loop
                int[][] distance = {    { 1000, 2, 110, 94, 71, 76, 25, 56, 94, 67 },
                                        { 2, 1000, 26, 70, 62, 60, 63, 62, 70, 49 },
		...
		store = new Store();
		varsMatrix = new IntVar[noCities][1];
   ...
   public boolean searchMaxRegretForMatrixOptimal() {
	...
	public static void main(String args[]) {
		...
		ShortestPath example = new ShortestPath();
